...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-tamara.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-tamara)
...
```bash
php artisan vendor:publish --tag="laravel-tamara-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-tamara-views"
```

## Usage

```php
$tamara = new AlazziAz\Tamara();
echo $tamara->echoPhrase('Hello, AlazziAz!');
```
